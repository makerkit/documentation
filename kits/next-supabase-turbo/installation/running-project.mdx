...
When you are ready to deploy the project to production, please follow the [checklist](checklist) to ensure everything is set up correctly.

NB: using Supabase's hosted instance is akin to deploying to production - which means that you'd still need to follow the checklist to ensure everything is set up correctly.