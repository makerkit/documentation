...
The [Umami](https://umami.is/) analytics provider in Remix Supabase Turbo is a simple way to integrate Umami Analytics into your Next.js application using the Makerkit's Analytics package.
