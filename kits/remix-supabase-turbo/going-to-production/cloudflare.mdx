...
**Cloudflare support is still a work in progress.**
...
### 0. Run the automated script

To deploy your Remix app to Cloudflare, you can run the automated script:

```bash
turbo gen cloudflare
```

This script bootstraps some of the changes needed to deploy your Remix app to Cloudflare.

### 1. Update all "@remix-run/node" to "@remix-run/cloudflare"
