...
1. Remix App Router (using Turbopack for faster builds)
...
5. Configurable mailers (SMTP with Nodemailer, Resend and Cloudflare Workers)
...
- **@kit/keystatic**: Keystatic package that defines the schema and logic for managing Keystatic. This is used by the @kit/cms package and abstracts the Keystatic API. Set to be replaced.
