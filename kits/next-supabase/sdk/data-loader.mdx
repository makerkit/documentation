---
title: "Data Loader SDK - Fetching data from Supabase directly from declarative React Components"
label: "Data Loader SDK"
position: 5
description: "Fetching data from Supabase directly from declarative React Components using the Data Loader SDK - a lightweight wrapper around the Supabase JS Client."
---
