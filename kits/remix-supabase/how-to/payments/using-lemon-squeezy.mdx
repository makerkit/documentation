---
title: "Using Lemon Squeezy instead of Stripe in your Makerkit application"
label: Using Lemon Squeezy instead of Stripe
position: 4
description: "How to use Lemon Squeezy instead of Stripe in your Makerkit application"
---
