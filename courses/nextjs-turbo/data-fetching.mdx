...
<Image src='/assets/courses/next-turbo/support-ticket-detail.webp' width={3032} height={1664} alt='Support Ticket Detail' />
...
function SendMessageInput({
  ...
  return (
    <form
      className={'sticky bottom-4 mt-auto z-10'}
    ...
    >
      <Input
        ...
        type="text"
        className={'h-16 border pr-36 bg-background shadow-xl'}
      />
