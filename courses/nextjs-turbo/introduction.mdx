...
It is highly recommended to follow along using the complete repository at [makerkit/next-supabase-saas-kit-turbo-course](https://github.com/makerkit/next-supabase-saas-kit-turbo-course). You need a valid license to use the course.
...
This will start the Next.js development server at [http://localhost:3000](http://localhost:3000). You can now open your browser and navigate to this URL to see the project running.
...
Turborepo is a monorepo tool that allows you to manage multiple packages in a single repository. It provides a set of commands to manage the packages and dependencies in your project. PNPM is the package manager we use in combination with Turborepo to manage the dependencies and packages in your project.
...
In fact, Turborepo is able to detect changes that affect the dependencies and packages in your project and cache. For example, try running `pnpm run typecheck`: the first time, it will check all the packages. Now, run it again: it will feel instantaneous, as all the packages were cached. However, let's make a change to any package: now, the package and its dependents will be computed again.
...
<Image src='/assets/courses/next-turbo/turbo-architecture.webp' width='618' height='377' />
...
<Image src='/assets/courses/next-turbo/turbo-architecture-apps.webp' width='618' height='377' />

The `packages` directory contains the following packages.

<Image src='/assets/courses/next-turbo/turbo-architecture-packages.webp' width='618' height='377' />
...
<Image src='/assets/courses/next-turbo/turbo-architecture-apps-packages.webp' width='1080' height='377' />
...
<Image src="/assets/courses/next-turbo/routing-overview.webp" width="760" height="255" />
...
<Image src="/assets/courses/next-turbo/marketing-routing-overview.webp" width="703" height="260" />
...
<Image src="/assets/courses/next-turbo/home-routing-overview.webp" width="548" height="399" />
