...
<Image src="/assets/courses/next-turbo/nextjs-page-anatomy.webp" width={"965"} height={"658"} />
...
<Image src="/assets/courses/next-turbo/nextjs-page-data-fetching.webp" width={"619"} height={"429"} />
...
<Image src="/assets/courses/next-turbo/home-accounts-list.webp" width={"1640"} height={"810"} />
...
<Image src="/assets/courses/next-turbo/empty-tickets-page.webp" width={"1780"} height={"834"} />
...
```tsx {8-13} title="apps/web/home/[account]/tickets/page.tsx"
export default function TicketsPage(props: TicketsPageProps) {
  const client = getSupabaseServerClient();
  const service = createTicketsService(client);
...
<Image src="/assets/courses/next-turbo/tickets-page.webp" width={"3000"} height={"1276"} />
